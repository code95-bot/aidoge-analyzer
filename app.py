...
# تحميل الرموز من OKX بشكل ديناميكي
exchange = ccxt.okx()
markets = exchange.load_markets()
crypto_usdt_pairs = [symbol for symbol in markets if symbol.endswith("/USDT")]

# واجهة اختيار العملة من القائمة الديناميكية
symbol = st.sidebar.selectbox("🔄 Sélectionner la crypto :", crypto_usdt_pairs, index=crypto_usdt_pairs.index("AIDOGE/USDT") if "AIDOGE/USDT" in crypto_usdt_pairs else 0)
